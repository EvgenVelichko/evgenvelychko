...
export const Portfolio: React.FC = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            image: new URL('../../assets/project/project3.webp', import.meta.url)
                .href,
            tags: ['index.html', 'CSS', 'JavaScript'],
        ...
        },
        {
            ...
            image: new URL('../../assets/project/project4.webp', import.meta.url)
                .href,
            tags: ['index.html', 'CSS', 'JavaScript'],
        ...
        },
        {
            ...
            image: new URL('../../assets/project/project5.webp', import.meta.url)
                .href,
            tags: ['index.html', 'CSS', 'JavaScript'],
        ...
        },
        {
            ...
            image: new URL('../../assets/project/project6.webp', import.meta.url)
                .href,
            tags: ['index.html', 'CSS', 'JavaScript'],
