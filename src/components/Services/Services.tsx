...
export const Services: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Creating responsive, intuitive user interfaces using modern JavaScript frameworks like React, Vue, and Angular.',
      icon: <Code size={40} />
    },
    {
      title: 'Backend Development',
      description: 'Building robust server-side applications and APIs using Node.js, Express, and other technologies.',
      icon: <Server size={40} />
    },
    {
